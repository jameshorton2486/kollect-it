  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-normal font-sans tracking-wide transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold-500 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
         ...
         */
        default:
          "bg-cta-600 text-white border border-cta-600 hover:bg-cta-700 hover:border-gold-500 shadow-sm hover:shadow-md active:bg-cta-800",

        /**
         * Destructive: For dangerous actions
         */
        destructive:
          "bg-semantic-error-500 text-white hover:bg-semantic-error-500/90 shadow-sm",
         ...
         */
        outline:
          "border-2 border-gold-500 bg-transparent text-ink-900 hover:bg-gold-500 hover:text-ink-900 shadow-sm hover:shadow-md",

        /**
         * Secondary: Soft grey for secondary actions
         */
        secondary:
          "bg-surface-200 text-ink-900 border border-border-300 hover:bg-surface-300 hover:border-ink-400",
         ...
         */
        link:
          "text-ink-900 underline-offset-4 hover:underline hover:text-gold-600",
      },
      size: {
