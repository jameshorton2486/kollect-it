        ...
        <div className="grid gap-8 py-10 md:py-12 lg:grid-cols-[1.5fr,2.5fr]">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-3 pt-2">
              ...
              <a href="#" aria-label="Facebook" className="flex h-8 w-8 items-center justify-center rounded-full bg-white/10 text-white hover:bg-white/20 hover:text-lux-gold transition-all">
                <Facebook className="h-4 w-4" />
              </a>
              <a href="#" aria-label="Twitter" className="flex h-8 w-8 items-center justify-center rounded-full bg-white/10 text-white hover:bg-white/20 hover:text-lux-gold transition-all">
            ...
            <div className="grid grid-cols-2 gap-6 sm:grid-cols-3">
              {columnSections.map((section) => (
                <div key={section.title}>
                  <h3 className="text-base font-semibold tracking-[0.12em] uppercase text-lux-gold mb-4">
                    {section.title}
                  </h3>
                  <ul className="space-y-2">
                    {section.links.map((link) => (
                      <li key={link.label}>
                        <Link
                          href={link.href}
                          className="text-sm text-white hover:text-lux-gold transition-colors"
                        >
                          {link.label}
                        </Link>
                      </li>
