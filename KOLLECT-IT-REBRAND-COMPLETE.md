# 🎯 KOLLECT-IT REBRAND - COMPLETE MESSAGING GUIDE
...
- Investors/resellers
- People who want to SELL items (hybrid model)
...
[CTA Button: "Tell Us About Your Items"]
```
...
### Replace "Trusted by museums and private collectors" with:
...
[CTA 1: Browse Collection] [CTA 2: Sell Your Items]
```
...
Valued using industry-standard resources. We're open to discussion if you disagree.

FAIRLY PRICED
Between auction value and retail price. Better deal than traditional auctions.

INSURED & TRACKED SHIPPING
Arrives safely, ships in 3-4 business days
```
...
Insured shipping. Fair pricing. Full visibility into what you're buying.
```
...
✓ Fair offer within 48 hours
✓ Buy or consignment options
✓ No commission on consignment sales

[CTA: Tell Us About Your Items]
```
...
Every item is professionally valued using industry-standard resources.
...
- ✅ Acknowledge you're a solo operator
- ✅ Welcome questions and corrections
- ✅ Use "we" to feel personal, not corporate
...
- ❌ Imply you have a large team
- ❌ Make promises you can't keep
- ❌ Use corporate jargon
- ❌ Oversell the authentication (you use tools, not magic)
...
- [ ] Replace tagline (remove furniture)
- [ ] Rewrite authentication section
- [ ] Add "Sell Your Items" section
- [ ] Create About page (use text provided above)
- [ ] Update category descriptions
- [ ] Update shipping/returns messaging
- [ ] Update trust-building section
- [ ] Review all CTAs (are they clear?)
- [ ] Test on mobile
...
Use these everywhere to stay consistent:

1. "Professionally valued, fairly priced, personally curated"
2. "Skip the auction house fees. Sell directly."
3. "Items worth $500-$15,000 that deserve expert attention"
4. "We authenticate, listen, and adjust if we're wrong"
5. "Real communication. Real answers. One person, many collectibles."
...
- "Ask a Question" (new, emphasize communication)
- "Contact Us" (new, for sellers)

---

## ✅ NEXT STEPS

1. **Review this document** - Does the tone feel right?
2. **Approve messaging** - Any changes you want?
3. **I'll create copy files** for each page (homepage, about, categories, etc.)
4. **You'll update the site** with new text
5. **Test & deploy**

---

**This rebrand transforms Kollect-It from "luxury marketplace" to "honest, fair alternative to auction houses."**

**The key insight:** You're not selling luxury. You're solving a problem (items too small for auctions, too risky for eBay).

**Does this feel right to you?** Any changes needed?
