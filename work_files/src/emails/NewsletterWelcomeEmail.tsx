    ...
    <Html>
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Text style={text}>
            Thank you for joining the Kollect-It Collector's List! You'll be
            the first to know when new pieces arrive – from rare books and fine
            art to historic militaria and unique collectibles.
          </Text>

          <Text style={text}>
            Every item on Kollect-It is carefully researched, photographed,
            and authenticated before listing. We focus on quality over quantity,
            so you can expect thoughtfully curated updates rather than constant
            emails.
          </Text>
