...
from modules.env_loader import validate_environment

def validate_env_before_startup():
    ...
    if not validate_environment():
        ...
        print("=" * 60)
        print()
        print("Please ensure your .env.local file in the main repo contains")
        print("all required API keys and credentials.")
        print()
        print("Expected location: C:\\Users\\james\\kollect-it\\.env.local")
        print()
        input("Press Enter to exit...")
        sys.exit(1)
    
    print("Starting Kollect-It Product Application...\n")
...
class KollectItApp(QMainWindow):
    ...
    def load_config(self) -> dict:
        ...
        try:
            ...
            try:
                # Load config using standard JSON (env vars loaded via centralized loader)
