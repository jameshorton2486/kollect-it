...
class ImageKitUploader:
    ...
    def __init__(self, config: dict):
        ...
        # Use centralized env loader - required variables
        self.public_key = get_required_env("IMAGEKIT_PUBLIC_KEY")
        self.private_key = get_required_env("IMAGEKIT_PRIVATE_KEY")
        self.url_endpoint = get_env("IMAGEKIT_URL_ENDPOINT") or ik_config.get("url_endpoint", "https://ik.imagekit.io/kollectit")
