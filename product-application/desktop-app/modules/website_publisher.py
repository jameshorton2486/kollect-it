...
class WebsitePublisher:
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        # API configuration - use centralized env loader
        api_config = config.get("api", {})
        self.base_url = get_env("API_BASE_URL") or api_config.get("production_url", "https://kollect-it.com")
        self.api_key = get_required_env("PRODUCT_INGEST_API_KEY")
        ...
        if not self.is_configured():
            return {
                ...
                "message": (
                    ...
                    "Add it to the MAIN repo .env.local file:\n\n"
                    "PRODUCT_INGEST_API_KEY=your-api-key-here\n\n"
                    "This desktop app now reads secrets from the main repository."
                )
            }
            ...
            try:
                ...
                if response.status_code == 201:
                    ...
                    return {
                        ...
                        "message": (
                            "Invalid API key.\n\n"
                            "Check PRODUCT_INGEST_API_KEY in the main repo .env.local file."
                        )
                    }
