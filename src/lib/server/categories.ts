...
const FALLBACK_CATEGORIES = [
  {
    ...
    name: 'Fine Art',
    slug: 'fine-art',
    description: 'Original paintings, drawings, and sculptures from established artists',
  ...
  },
  {
    ...
    name: 'Memorabilia',
    slug: 'memorabilia',
    description: 'Signed items, limited editions, and entertainment memorabilia',
