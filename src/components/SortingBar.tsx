  ...
  return (
    <div className="mb-6 flex flex-wrap items-center justify-between gap-3 border-b border-ink-300 pb-3">
      ...
      <div className="flex items-center gap-2">
        ...
        <select
          id="sort"
          className="rounded border border-ink-300 bg-white px-3 py-2 text-sm leading-tight focus:outline-none focus:ring-2 focus:ring-gold focus:ring-offset-2 focus:ring-offset-white"
