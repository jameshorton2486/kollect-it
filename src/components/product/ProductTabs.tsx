            ...
            >
              <div className="rounded-lg border border-brand-gold/20 bg-white p-6">
                <h3 className="font-serif text-2xl text-brand-navy mb-4 flex items-center gap-2">
                  <span className="text-brand-gold">📖</span> Product
                  Description
                </h3>
          ...
          {activeTab === "shipping" && (
            ...
            >
              <div className="rounded-lg border border-brand-gold/20 bg-white p-6 space-y-6">
                <div>
                  <h3 className="font-serif text-2xl text-brand-navy mb-4 flex items-center gap-2">
                    <span className="text-brand-gold">📦</span> Shipping
                    Information
                  </h3>
                ...
                <div className="grid md:grid-cols-3 gap-4">
                  <div className="rounded-lg border border-ink-tertiary/10 p-4 bg-gradient-to-br from-parchment to-white">
                    <p className="text-xs uppercase tracking-wider font-semibold text-brand-gold mb-2">
                      Standard
                    </p>
                    <p className="font-serif text-lg text-brand-navy mb-1">
                      5-7 Business Days
                    </p>
                ...
                <div className="border-t border-ink-tertiary/10 pt-6">
                  <h4 className="font-serif text-lg text-brand-navy mb-3">
                ...
                <div className="border-t border-ink-tertiary/10 pt-6">
                  ...
                  <p className="text-sm text-ink-secondary mb-3">
                    ...
                    contact our concierge team to initiate a return – we'll even
                  ...
                  <p className="text-xs bg-brand-gold/10 border border-brand-gold/20 rounded p-3 text-brand-navy font-medium">
                    💡 Not satisfied? No questions asked returns – we want you
          ...
          {activeTab === "authentication" && (
            ...
            >
              <div className="rounded-lg border border-green-200 bg-white p-6">
                <h3 className="font-serif text-2xl text-brand-navy mb-4 flex items-center gap-2">
                  <span className="text-green-600">✓</span> Our Authentication
                  Guarantee
                </h3>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="rounded-lg border border-brand-gold/20 bg-white p-6">
                  <h4 className="font-serif text-lg text-brand-navy mb-4">
          ...
          {activeTab === "guarantee" && (
            ...
            >
              <div className="rounded-lg border-2 border-green-200 bg-green-50/30 p-6">
                <h3 className="font-serif text-2xl text-brand-navy mb-4 flex items-center gap-2">
                  <span className="text-green-600">🛡️</span> Lifetime
