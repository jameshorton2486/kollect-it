          ...
          {products.map((product) => (
            ...
            >
              ...
              <div className="related-product-info mt-3 space-y-2">
                {/* Category Badge */}
                <p className="text-[10px] uppercase tracking-wider font-bold text-brand-gold">
                ...
                <div className="flex items-baseline justify-between pt-1">
                  <p className="related-product-price font-serif text-lg font-bold text-brand-navy">
                  ...
                  <svg
                    ...
                    stroke="currentColor"
                    strokeWidth="2"
                    className="text-brand-gold opacity-0 group-hover:opacity-100 transition-opacity"
                    aria-hidden="true"
                  >
                    <polyline points="9 18 15 12 9 6" />
                  </svg>
