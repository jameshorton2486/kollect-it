...
export default function ProductInfo({ product, sku }: ProductInfoProps) {
  ...
  return (
    <div className="product-info">
      ...
      {product.condition && (
        <div
          className="mt-2 inline-flex items-center rounded-full border border-brand-gold px-3 py-1 text-[12px] font-medium text-brand-gold"
      ...
      {/* Title */}
      <h1 className="product-info-title ki-heading font-serif text-brand-navy leading-tight text-4xl mt-3">
        {product.title}
      </h1>
      ...
      <div className="mt-6 rounded-lg border border-brand-gold/20 bg-gradient-to-br from-brand-gold/5 to-transparent p-4">
        ...
        <div className="flex items-baseline gap-3">
          <div className="text-4xl font-serif font-bold text-brand-navy">
      ...
      <div className="product-info-details mt-6 rounded-lg border border-ink-tertiary/10 bg-gradient-to-br from-parchment to-white p-5">
        <p className="text-xs uppercase tracking-wider text-brand-gold font-semibold mb-4">
          Item Specifications
        </p>
        <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
          {product.artist && (
            <div className="product-detail-item">
              ...
              <span className="product-detail-value block text-base font-medium text-brand-navy">
                {product.artist}
              </span>
            </div>
          )}
          ...
          <div className="product-detail-item">
            ...
            <span className="product-detail-value block text-base font-medium text-brand-navy font-mono">
              {sku}
            </span>
          </div>
          <div className="product-detail-item">
      ...
      <div className="mt-6 rounded-lg border border-brand-gold/20 bg-brand-gold/5 p-4">
        <p className="text-xs uppercase tracking-wider text-brand-gold font-semibold mb-3">
