...
export default function Search() {
  ...
  return (
    <div className="relative" ref={boxRef}>
      ...
      >
        <div
          className={`flex w-full items-center gap-2 rounded border px-3 py-2 bg-white focus-within:border-[#B1874C] focus-within:ring-1 focus-within:ring-[#B1874C]`}
        >
          {/* Magnifying glass */}
          <svg
            width="18"
          ...
          {query && (
            <button
              ...
              className="rounded p-1 hover:text-brand-gold"
            >
              <svg
                width="16"
                height="16"
                  ...
                  <li key={p.id}>
                    ...
                    >
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <div className="truncate text-[11px] uppercase tracking-wide text-brand-gold">
                          {p.category?.name ?? ""}
                        </div>
                      </div>
                      <div className="shrink-0 text-[14px] font-semibold text-brand-gold">
                        {formatUSD0(p.price)}
                      </div>
                    </Link>
                  </li>
