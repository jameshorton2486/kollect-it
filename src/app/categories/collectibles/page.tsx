      ...
      <section className="border-b border-surface-200 bg-surface-50">
        <div className="mx-auto max-w-6xl px-6 py-14 lg:py-20">
          ...
          <div className="rounded-2xl border border-dashed border-surface-300 bg-surface-100 px-6 py-10 text-sm text-ink-700">
            ...
            <p className="mt-2">
              Inventory in this category is still small. I add new collectibles as I find good fits—check back soon or contact me if you&apos;re on the hunt for something specific.
            </p>
          </div>
        </div>
      </section>
