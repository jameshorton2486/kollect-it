        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-10">
            ...
            <section>
              ...
              <p className="leading-relaxed text-ink-700 mb-4">
                Before any item appears on the site, I review:
              </p>
              <ul className="list-disc list-inside space-y-2 leading-relaxed text-ink-700 ml-4">
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2 leading-relaxed text-ink-700 ml-4 mt-4">
