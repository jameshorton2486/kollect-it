  ...
  return (
    <div className="min-h-screen bg-surface-2">
      <div className="ki-container px-4 md:px-6 lg:px-8 py-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-serif font-bold text-ink mb-2">Admin Settings</h1>
          <p className="text-ink-secondary">Configure administrative options and preferences</p>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-lg border border-border-neutral p-6">
            <h2 className="text-xl font-serif font-bold text-ink mb-4">Platform Settings</h2>
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between p-4 bg-surface-2 rounded-lg">
                <div>
                  <h3 className="font-semibold text-ink">Allow New Registrations</h3>
                  <p className="text-sm text-ink-secondary mt-1">Let new users create accounts and register</p>
                </div>
                <label className="relative inline-flex items-center cursor-pointer">
                  <input
                    type="checkbox"
              ...
              <div className="flex items-center justify-between p-4 bg-surface-2 rounded-lg">
                <div>
                  ...
                  <p className="text-sm text-ink-secondary mt-1">Send email notifications for orders and updates</p>
                </div>
                <label className="relative inline-flex items-center cursor-pointer">
                  <input
                    type="checkbox"
              ...
              <div className="flex items-center justify-between p-4 bg-surface-2 rounded-lg">
                <div>
                  <h3 className="font-semibold text-ink">Auto-Approve Listings</h3>
                  <p className="text-sm text-ink-secondary mt-1">Automatically publish new product listings</p>
                </div>
                <label className="relative inline-flex items-center cursor-pointer">
                  <input
                    type="checkbox"
          ...
          {/* System Info */}
          <div className="bg-white rounded-lg border border-border-neutral p-6">
            <h2 className="text-xl font-serif font-bold text-ink mb-4">System Information</h2>
