                  ...
                  {editingId === category.id ? (
                    <>
                      ...
                      <button
                        ...
                        className="flex-1 bg-gray-300 hover:bg-gray-400 text-gray-900 px-3 py-2 rounded text-sm font-medium flex items-center justify-center gap-2 transition-colors"
                      >
                        <X size={16} />
                        Cancel
                      </button>
