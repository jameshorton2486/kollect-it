        ...
        <div className="container">
          <div className="admin-stats-grid">
            ...
            <div className="admin-stat-card">
              ...
              <div className="stat-content">
                ...
                <p className="stat-value">${stats.totalRevenue.toLocaleString('en-US', { minimumFractionDigits: 2 })}</p>
              </div>
            </div>
            ...
            <div className="admin-stat-card">
              ...
              <div className="stat-content">
                ...
                <p className="stat-value">${stats.averageSpent.toLocaleString('en-US', { minimumFractionDigits: 2 })}</p>
              </div>
            </div>
          </div>
          ...
          <div className="admin-filters">
            ...
            <div className="admin-filter-group">
              ...
              <select id="sort-select" value={sortBy} onChange={(e) => handleSort(e.target.value as typeof sortBy)} className="admin-select">
          ...
          <div className="admin-table-container">
            {filteredCustomers.length === 0 ? (
              <div className="admin-empty-state">
                ...
                <p>
                  {searchQuery ? 'Try adjusting your search' : 'Customers will appear here once they create accounts'}
                </p>
              </div>
            ) : (
              <table className="admin-table">
                <thead>
                  <tr>
                    ...
                    <th>Phone</th>
                    <th>
                      <button onClick={() => handleSort('orders')} className="sort-button">
                        Orders {sortBy === 'orders' && (sortOrder === 'asc' ? '↑' : '↓')}
                      </button>
                    </th>
                    <th>
                      <button onClick={() => handleSort('spent')} className="sort-button">
                ...
                <tbody>
                  {filteredCustomers.map((customer) => (
                    <tr key={customer.id}>
                      ...
                      <td>
                        <span className="text-ink-secondary">{customer.email}</span>
                      </td>
                      <td>
                        <span className="text-ink-secondary">{customer.phone || '—'}</span>
                      </td>
                      <td>
