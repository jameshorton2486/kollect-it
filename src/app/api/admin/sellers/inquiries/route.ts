  ...
  try {
    ...
    const inquiries = [
      ...
      },
      {
        ...
        adminNotes: ['Contacted stamp expert for valuation', 'Initial assessment looks promising'],
      },
      {
        id: '3',
        ...
        adminNotes: ['Approved for listing', 'Photos requested', 'Contract sent'],
      },
      {
        id: '4',
      ...
      },
      {
        ...
        adminNotes: ['Item is a reproduction, not authentic antique', 'Explained our authenticity policy'],
      },
    ];
