        ...
        <div className="container py-6">
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <p className="text-[14px] text-[var(--color-gray-dark)]">
            ...
            >
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                <div className="flex items-center justify-between rounded border border-[var(--color-gray-light)] p-3">
                  <span className="text-[12px] uppercase tracking-wide text-[var(--color-gray-dark)]">
                    Name
                  </span>
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                ...
                <button className="inline-flex items-center justify-center rounded border border-[var(--color-gray-light)] px-4 py-2 text-[14px] text-[var(--color-charcoal)] hover:bg-cream">
                  Change Password
                </button>
              </div>
            </div>
                    ...
                    return (
                      ...
                      >
                        <div className="flex flex-col">
                          ...
                          <span className="text-[12px] text-[var(--color-gray-dark)]">
                            {new Date(order.createdAt).toLocaleDateString()}
                          </span>
                        </div>
                        <div className="flex flex-1 flex-col gap-2 md:flex-row md:items-center md:justify-end">
                          <span className="text-[14px] text-[var(--color-gray-dark)]">
              ...
              {wishlist.length === 0 ? (
                ...
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                  {wishlist.map((item) => (
                    <div
                      key={item.id}
                      className="group rounded-lg border border-[var(--color-gray-light)] bg-white p-3"
                    >
                      <Link
                      ...
                      >
                        {item.product.images[0] ? (
                          ...
                          <div className="flex h-[200px] items-center justify-center bg-cream text-[var(--color-gray-dark)]">
                            No Image
                          </div>
                        )}
                      </Link>
                      <div className="mt-3 flex flex-col gap-1">
                        ...
                        <Link
                          href={`/product/${item.product.slug}`}
                          className="font-medium hover:text-[var(--color-muted-gold)]"
                        >
                          {item.product.title}
                        </Link>
              ...
              <div className="space-y-4">
                <label className="flex items-center justify-between rounded border border-[var(--color-gray-light)] p-3">
                  <div>
                    ...
                    <span className="text-[13px] text-[var(--color-gray-dark)]">
