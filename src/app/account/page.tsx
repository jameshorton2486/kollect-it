...
export default function AccountPage() {
  ...
  return (
    <div className="account-page">
      {/* Header */}
      <div className="border-b border-[hsl(var(--border-300))] bg-white">
      ...
      <div className="ki-section">
        <div className="container mx-auto">
          ...
          {activeTab === "profile" && (
            <div
              className="rounded-lg border border-[hsl(var(--border-300))] bg-white p-6"
              role="tabpanel"
              id="panel-profile"
              ...
              {wishlist.length === 0 ? (
                ...
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                  {wishlist.map((item) => (
                    <div
                      key={item.id}
                      className="group rounded-lg border border-[hsl(var(--border-300))] bg-white p-3"
                    >
                      <Link
