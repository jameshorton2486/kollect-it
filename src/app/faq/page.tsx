  ...
  return (
    <main className="bg-white" role="main">
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-xl text-ink-light leading-relaxed">
              Find answers to common questions about authentication, shipping, returns, collecting, and our consignment services. Can't find what you're looking for? Contact our team anytime.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          <div className="max-w-5xl mx-auto">
            ...
            {faqCategories.map((category) => (
              <div key={category.id} id={category.id} className="mb-16 md:mb-20">
                ...
                <div className="space-y-4">
                  {category.faqs.map((faq, idx) => (
                    <details key={idx} className="faq-item group border border-surface-2 rounded-lg p-6 hover:shadow-md transition-shadow">
      ...
      <section className="py-16 md:py-24 bg-surface-1">
        <div className="container mx-auto px-4 md:px-6 lg:px-8 text-center">
          <div className="max-w-3xl mx-auto">
            <h3 className="font-serif text-4xl text-ink mb-4">Still Have Questions?</h3>
            <p className="text-xl text-ink-light mb-8">
              Our team of experts is here to help. Reach out with any questions about our collection, authentication, consignment, or anything else.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              <Link href="/contact" className="inline-block bg-accent-gold text-white font-semibold px-8 py-4 rounded-lg hover:opacity-90 transition-opacity">
                Contact Us
              </Link>
              <Link href="/sell" className="inline-block bg-white text-accent-gold font-semibold px-8 py-4 rounded-lg border-2 border-accent-gold hover:bg-accent-gold hover:text-white transition-colors">
                Sell With Us
              </Link>
            </div>
          </div>
