    ...
    <div className="min-h-screen bg-lux-pearl">
      ...
      <div className="bg-white border-b">
        <div className="max-w-3xl mx-auto px-4 py-6">
          <Link
            href="/admin/products"
            className="inline-flex items-center gap-2 text-ink-600 hover:text-lux-black mb-4"
          >
            <ArrowLeft size={20} />
            Back to Products
          </Link>
      ...
      <div className="max-w-3xl mx-auto px-4 py-6">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="bg-white rounded-lg border p-6 space-y-4">
            <label className="flex items-center gap-3">
              <input
                ...
                className="w-5 h-5 rounded border-border-300 text-amber-600 focus:ring-amber-500"
              />
          ...
          <div className="flex justify-end gap-4">
            <Link
              href="/admin/products"
              className="px-6 py-2 border rounded-lg hover:bg-lux-cream"
            >
              Cancel
            </Link>
            <button
