      ...
      <nav className="container mx-auto px-4" aria-label="Main navigation">
        <div className="flex items-center justify-between h-20 transition-all duration-300">
          ...
          <div className="hidden md:flex md:items-center md:space-x-10">
            {navigation.map((item) => (
              <Link
                key={item.name}
                href={item.href}
                className="text-sm font-sans font-medium tracking-wide text-ink-600 hover:text-gold-600 transition-colors uppercase"
              >
                {item.name}
              </Link>
            ))}
          ...
          <div className="hidden md:flex items-center space-x-2">
            <Button variant="ghost" size="icon" className="text-ink-600 hover:text-ink-900 hover:bg-surface-200">
            ...
            <Button variant="ghost" size="icon" className="text-ink-600 hover:text-ink-900 hover:bg-surface-200 relative">
          ...
          <div className="flex md:hidden items-center space-x-4">
            <Button variant="ghost" size="icon" className="text-ink-600">
              <ShoppingCart className="h-5 w-5" />
            </Button>
            ...
            <div className="flex flex-col p-4 space-y-2">
              {navigation.map((item) => (
                <Link
                  key={item.name}
                  href={item.href}
                  className="text-lg font-serif font-medium text-ink-800 py-3 border-b border-border-200 last:border-0"
              ...
              <div className="pt-4 flex gap-4">
                <Button className="w-full bg-cta-600 text-white">Sell With Us</Button>
                <Button variant="outline" className="w-full border-ink-200">My Account</Button>
              </div>
            </div>
          </div>
        )}
