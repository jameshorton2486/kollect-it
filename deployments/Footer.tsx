      ...
      <div className="container mx-auto px-4 py-16 md:py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-lux-gray-light text-sm leading-relaxed mb-6 max-w-xs">
            ...
            <div className="flex items-center space-x-4">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="p-2 text-lux-gray hover:text-lux-white transition-colors"
                >
          ...
          {/* Shop Links */}
          <div>
            <h4 className="text-xs font-medium text-lux-gold uppercase tracking-widest mb-6">
              Shop
            </h4>
