    ...
    <main className="ki-section container mx-auto px-4 md:px-6 lg:px-8 py-12" role="main">
      <div className="max-w-md mx-auto">
        <div className="mb-8">
          ...
          <p className="text-ink-secondary">Join Kollect-It and start collecting</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4" noValidate>
          ...
          <div>
            ...
            <p className="text-xs text-ink-secondary mt-1">Must be at least 6 characters</p>
            {validationErrors.password && (
        ...
        <div className="text-center">
          <p className="text-sm text-ink-secondary">
            ...
            <Link href="/login" className="font-medium text-link hover:text-link/80 transition-colors">
              Sign in
            </Link>
          </p>
        </div>
