...
export default function LuxuryEnhancements() {
  ...
  useEffect(() => {
    ...
    const trustIcons =
      document.querySelectorAll<HTMLElement>(".trust-icon-item");
    ...
    // Animated Dividers
    const dividers =
      document.querySelectorAll<HTMLElement>(".animated-divider");
    ...
    const handleStickyCart = () => {
      const stickyPanel =
        document.querySelector<HTMLElement>(".sticky-cart-panel");
      if (stickyPanel) {
    ...
    const splitFadeEls = document.querySelectorAll<HTMLElement>(
      ".split-fade-left, .split-fade-right",
    );
    ...
    const verificationTimeline = document.querySelectorAll<HTMLElement>(
    ...
    const checkoutSections =
      document.querySelectorAll<HTMLElement>(".checkout-section");
    checkoutSections.forEach((el) => io.observe(el));

    // Password Toggle Functionality
    const passwordToggles =
      document.querySelectorAll<HTMLElement>(".password-toggle");
    ...
    const charCounter =
      document.querySelector<HTMLElement>(".character-counter");
